...
<div class="container ">
    <div id="overflowTest" class="">
        ...
        <b>SEÇÃO 1 - TERMOS DO SITE LEX CENTER</b>
        <br><br>
        Ao concordar com os Termos de serviço, você confirma que você é maior de idade em seu estado ou província de residência e que você nos deu seu consentimento para permitir que qualquer um dos seus dependentes menores de idade usem esse site.<br><br>
        ...
        <b>SEÇÃO 2 - CONDIÇÕES GERAIS</b>
        <br><br>
        Reservamos o direito de recusar o serviço a qualquer pessoa por qualquer motivo a qualquer momento.<br><br>
        Você entende que o seu conteúdo, pode ser transferido sem criptografia e pode: (a) ser transmitido por várias redes; e (b) sofrer alterações para se adaptar e se adequar às exigências técnicas de conexão de redes ou dispositivos. As informações de cartão de crédito sempre são criptografadas durante a transferência entre redes.<br><br>
        Você concorda em não reproduzir, duplicar, copiar, vender, revender ou explorar qualquer parte do Serviço, uso do Serviço, acesso ao Serviço, ou qualquer contato no site através do qual o serviço é fornecido, sem nossa permissão expressa por escrito.<br><br>
        Os títulos usados nesse acordo são incluídos apenas por conveniência e não limitam ou  afetam os Termos.<br><br>
        
        <b>SEÇÃO 3 - PRECISÃO, INTEGRIDADE E ATUALIZAÇÃO DAS INFORMAÇÕES</b>
        <br><br>
        ...
        <b>SEÇÃO 4 - MODIFICAÇÕES DO SERVIÇO</b>
        <br><br>
        Os nossos produtos são sujeitos a alterações sem notificação.<br><br>
        ...
        <b>SEÇÃO 8 - LINKS DE TERCEIROS</b>
        <br><br>
        Certos produtos, conteúdos e serviços disponíveis pelo nosso Serviço podem incluir materiais de terceiros.<br><br>
        ...
        Não somos responsáveis por quaisquer danos ou prejuízos relacionados com a compra ou uso de mercadorias, serviços, recursos, conteúdo, ou quaisquer outras transações feitas em conexão com quaisquer sites de terceiros. Por favor, revise com cuidado as políticas e práticas de terceiros e certifique-se que você as entende antes de efetuar qualquer transação. As queixas, reclamações, preocupações ou questões relativas a produtos de terceiros devem ser direcionadas ao terceiro.<br><br>

        <b>SEÇÃO 9 - COMENTÁRIOS, FEEDBACK, ETC. DO USUÁRIO</b>
        <br><br>
        ...
        <b>SEÇÃO 10 - INFORMAÇÕES PESSOAIS</b>
        <br><br>
        O envio de suas informações pessoais através da loja é regido pela nossa Política de privacidade. Ver nossa Política de privacidade.<br><br>
        <b>SEÇÃO 11 - ERROS, IMPRECISÕES E OMISSÕES</b>
        <br><br>
        ...
        Não assumimos nenhuma obrigação de atualizar, alterar ou esclarecer informações no Serviço ou em qualquer site relacionado, incluindo, sem limitação, a informações sobre datas de concursos, exceto conforme exigido por lei. Nenhuma atualização específica ou data de atualização no Serviço ou em qualquer site relacionado, deve ser utilizada para indicar que todas as informações do Serviço ou em qualquer site relacionado tenham sido modificadas ou atualizadas.<br><br>
        <b>SEÇÃO 12 - USOS PROIBIDOS</b>
        <br><br>
        ...
        <b>SEÇÃO 13 - ISENÇÃO DE RESPONSABILIDADE DE GARANTIAS; LIMITAÇÃO DE RESPONSABILIDADE</b>
        <br><br>
        ...
        <b>SEÇÃO 18 - LEGISLAÇÃO APLICÁVEL</b>
        <br><br>
        Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de RUA BENEDITO RODRIGUES ALVES, 98 Casa Vila Jacobelli, Guaratingueta, SP, 12505190, Brazil.<br><br>
       
        <b>SEÇÃO 19 - ALTERAÇÕES DOS TERMOS DE SERVIÇO</b>
        <br><br>
        ...
        <b>SEÇÃO 20 - INFORMAÇÕES DE CONTATO</b>
        <br><br>
        As perguntas sobre os Termos de serviço devem ser enviadas para nós através do contato@lexcenter.com.br.<br><br>
    </div>
</div>
<br><br>