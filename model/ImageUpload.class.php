...
class ImageUpload{
    ...
    private $tipos =   array('jpg', 'jpeg', 'png','pdf');    
    ...
    protected function Resize($tmp, $novo_nome, $largura, $pasta) {
      ...
      * @param int - $produto ID do produto
       */  
      public function UploadArquivo($campo) {
	  ...
	  $time = date('ymdHis');
          ...
          if (!empty($_FILES)):
            ...
            <div class="modal-dialog" role="document">
                ...
                // retorno os dados
                $this->retorno = '<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Aviso!</h5>
