...
<h4 class="text-center">Nova postagem de Alunos Aprovados </h4>
<hr>
...
<form name="frm_produto" method="post" action=""  enctype="multipart/form-data">
    ...
    <div class="row">
        {* NOME DO CURSO*}
        <div class="col-md-6">
            <label>Nome do Edital/Ano/Concurso</label>
        ...
        <div class="col-md-6">
            ...
            <select name="con_categoria" id="con_categoria" class="form-control" required>                          
              ...
              {*  {foreach from=$CATEGORIAS item=C}  *}                  
                    <option value="{$CATEGORIAS.1.cate_id}">{$CATEGORIAS.1.cate_nome}</option>                                        
              {*  {/foreach}  *}              
            </select>
        </div>
        {*CATEGORIA *}
